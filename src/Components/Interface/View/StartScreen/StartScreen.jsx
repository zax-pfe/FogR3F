      ...
      <div className={s.startScreen}>
        <div className={s.svgContainer}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1603 1080" fill="none">
            <ellipse cx="803.822" cy="469.695" rx="681.469" ry="680.695" fill="#435853" fill-opacity="0.29" />
            <ellipse cx="679.92" cy="523.128" rx="679.92" ry="681.469" fill="#4FD1C5" fill-opacity="0.02" />
            <ellipse cx="747.309" cy="609.436" rx="681.469" ry="680.695" fill="#435853" fill-opacity="0.08" />
            <ellipse cx="881.263" cy="581.208" rx="681.469" ry="680.695" fill="#1A2F2A" fill-opacity="0.34" />
            <circle cx="923.08" cy="495.25" r="679.92" fill="#192A2E" fill-opacity="0.21" />
            <g filter="url(#filter0_i_837_1182)">
              <ellipse cx="803.822" cy="544.811" rx="681.469" ry="679.92" fill="#070D0C" />
            </g>
            <defs>
              <filter id="filter0_i_837_1182" x="122.354" y="-135.109" width="1362.94" height="1363.84" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
